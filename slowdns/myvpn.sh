...
sleep 2
clear
wget http://sgpx.cybervpn.site:81/Autoscript-by-azi-main/autoscript-ssh-slowdns-main/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
sleep 2
wget http://sgpx.cybervpn.site:81/Autoscript-by-azi-main/nginx-ssl.sh && chmod +x nginx-ssl.sh && ./nginx-ssl.sh
wget -q -O kanyut.sh http://sgpx.cybervpn.site:81/Autoscript-by-azi-main/kanyut.sh && chmod +x kanyut.sh && ./kanyut.sh
#install ssh ovpn
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
#exp
cd /usr/bin
wget -O xp "http://sgpx.cybervpn.site:81/Autoscript-by-azi-main/xp.sh"
chmod +x xp
sleep 1
wget -q -O /usr/bin/notramcpu "http://sgpx.cybervpn.site:81/Autoscript-by-azi-main/Finaleuy/notramcpu" && chmod +x /usr/bin/notramcpu
...
sleep 1
wget -q -O senmenu.sh http://sgpx.cybervpn.site:81/Autoscript-by-azi-main/senmenu.sh && chmod +x senmenu.sh && ./senmenu.sh
sleep 1
#install slowdns
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
wget -q -O slowdns.sh http://sgpx.cybervpn.site:81/Autoscript-by-azi-main/autoscript-ssh-slowdns-main/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh

wget -q -O bot.sh http://sgpx.cybervpn.site:81/Autoscript-by-azi-main/botssh/bot.sh && chmod +x bot.sh && ./bot.sh
