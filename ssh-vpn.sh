...
cd
cd
wget -O /usr/bin/badvpn-udpgw https://raw.githubusercontent.com/Amoebacoy/cv/main/ssh-vpn/badvpn-udpgw && chmod +x  /usr/bin/badvpn-udpgw
#system badvpn 7300
wget -O /etc/systemd/system/svr-7300.service https://raw.githubusercontent.com/Amoebacoy/cv/main/ssh-vpn/svr-7300.service && chmod +x  /etc/systemd/system/svr-7300.service
#system badvpn 7200
wget -O /etc/systemd/system/svr-7200.service https://raw.githubusercontent.com/Amoebacoy/cv/main/ssh-vpn/svr-7200.service && chmod +x  /etc/systemd/system/svr-7200.service
#system badvpn 7100
wget -O /etc/systemd/system/svr-7100.service https://raw.githubusercontent.com/Amoebacoy/cv/main/ssh-vpn/svr-7100.service && chmod +x  /etc/systemd/system/svr-7100.service
...
#installer OPH
wget https://raw.githubusercontent.com/Amoebacoy/cv/main/ohp/ohp.sh && chmod +x ohp.sh && ./ohp.sh
